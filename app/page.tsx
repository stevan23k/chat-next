      ...
      <div className="w-full max-w-4xl h-[700px] bg-slate-900/80 backdrop-blur-2xl rounded-3xl shadow-2xl border border-slate-800/50 flex flex-col overflow-hidden">
        ...
        <div className="bg-slate-800/90 p-5 shadow-xl border-b border-slate-700/50">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-2xl font-bold text-slate-100 tracking-tight">Chat</h1>
              <div className="flex items-center gap-2 mt-1">
                <div className={`w-2 h-2 rounded-full ${connected ? 'bg-slate-400 animate-pulse' : 'bg-slate-600'}`}></div>
          ...
          {mensajes.length === 0 && (
            <div className="flex items-center justify-center h-full">
              <div className="text-center">
                ...
                <p className="text-slate-500 text-xs mt-1">Comienza una conversación</p>
              </div>
            </div>
          )}
          ...
          {mensajes.map((mensaje, index) => {
            ...
            return (
              ...
              >
                ...
                <div
                  className={`max-w-xs lg:max-w-md xl:max-w-lg px-5 py-3 rounded-3xl shadow-xl transition-all duration-200 group-hover:shadow-2xl ${
                    isMine
        ...
        {/* Input Container */}
        <div ref={inputContainerRef} className="p-5 bg-slate-900/90 border-t border-slate-800/50 backdrop-blur-xl">
